...
%  standard deviations of the two modes. A1 and A2 are amplitude values,
%  and k is an offset value that raises the floor of the histogram. The
%  number of elements in the histogram vector P is 256 and sum(P) is
%  normalized to 1. MANUALHIST repeatedly prompts for the parameters and
%  plots the resulting histogram until the user types an 'x' to quit, and
%  then it returns the last histogram computed.
%
%  A good set of starting values is: (0.15, 0.05, 0.75, 0.05, 1, 0.07,
%  0.002).
...
%  Computer a default histogram in case the user quits before estimating at
%  least one histogram.
